...
const DoctorDashboard = () => {
  ...
  const loadUserData = async () => {
    try {
      ...
      setUser({
        firstName: 'Dr. María',
        lastName: 'González',
        email: 'maria.gonzalez@mediclab.com'
      });
    }
  };
  ...
  // Handle creating new appointment for patient
  ...
  const handleStatusUpdate = async (appointmentId, newStatus) => {
    try {
      const updatedAppointment = await appointmentsAPI.updateAppointment(appointmentId, {
        status: newStatus
      });
